...
public class BaseSharePreference {
    ...
    private static class LazyHolder {
        private static final BaseSharePreference INSTANCE = new BaseSharePreference(mContext);
    }

    public static BaseSharePreference getInstance(Context context) {
        mContext = context;
    ...
    private BaseSharePreference(SharedPreferences sp) {
        this.sp = sp;
        edit = sp.edit();
    }
